def define_search_keywords(domain):
    # Define search keywords based on domain expertise
    keywords = ["quantum", "cryptography", "key distribution", "entanglement", "teleportation"]
    print(f"Search Keywords for {domain}: {keywords}")
    return keywords
